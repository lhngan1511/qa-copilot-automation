...
/*
 V3ReviewDrawer — Drawer Review (Bước 5B).

 Mở khi tester chủ động bấm "Xem và duyệt".
   Header: TCxxx · tên testcase [×]
   Tabs  : Thông tin | Recording   (KHÔNG tab Dữ liệu — chưa chỉnh dữ liệu ở 5B)
   Footer: [Đóng] [Duyệt recording]
 Không action ở đầu Drawer. Không Generate/Run.
*/

export default function V3ReviewDrawer({ workspaceId, testCase, onClose, onApprove }) {
