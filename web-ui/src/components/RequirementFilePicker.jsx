...
export default function RequirementFilePicker({ file, error, disabled = false, onChange }) {
    ...
    return (
        <div className="file-picker requirement-file-picker">
            <input
                ref={inputRef}
                id="requirement-file"
            ...
            {!file ? (
                <label
                    className={`file-drop-zone requirement-file-picker__drop-zone ${dragActive ? "file-drop-zone--active" : ""} ${
                ...
                >
                    <span className="file-drop-zone__icon" aria-hidden="true">
                        <svg viewBox="0 0 24 24" focusable="false">
                            <path d="M7 18a5 5 0 0 1-.8-9.94A6.5 6.5 0 0 1 18.7 10.5 3.75 3.75 0 0 1 18.25 18H14" />
                            <path d="M12 20V10m0 0-3 3m3-3 3 3" />
                        </svg>
                    </span>
                ...
                <div className="selected-file requirement-file-picker__selected-file" aria-live="polite">
                    <div>
                        ...
                        <span className="selected-file__details">
                            ...
                            <small id="requirement-file-help">
                                Markdown · {formatFileSize(file.size)} · Sẵn sàng phân tích
                            </small>
                        </span>
                    </div>
                    <div className="selected-file__actions">
                        <button className="text-button requirement-file-picker__action" type="button" disabled={disabled} onClick={openFileDialog}>
                            Đổi file
                        </button>
                        <button
                            className="text-button text-button--danger requirement-file-picker__action"
                            type="button"
                            disabled={disabled}
                            onClick={clearFile}
