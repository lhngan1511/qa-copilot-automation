...
/*
 Sprint 1 — Automation Intelligence
 - Giữ nguyên testData object từ approved-testcases.json (không chuyển thành []).
 - Đọc module/feature/environment tự động từ JSON/.env; không bắt nhập lại.
 - Bỏ CodeGen Library (lưu/chọn/localStorage).
...
export default function AutomationWorkspacePage() {
    ...
    // Module / Feature tự đọc từ approved-testcases.json (first testcase có giá trị).
    ...
    // Sprint 1: sửa bug testCaseMappings — backend trả result.testCaseMappings.
