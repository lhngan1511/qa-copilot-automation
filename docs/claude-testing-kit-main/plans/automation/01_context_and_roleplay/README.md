...
**Skill:** `skills-qa-automation-engineer`
...
2. Thay thế các phần trong `[...]`:
   ...
   - **Kiến trúc:** Copy từ `.claude/skills/skills-framework-architect/SKILL.md` mục **Project Structure Templates** hoặc mô tả project hiện có
