...
Generated: 08:35:26 29 thg 7, 2026
...
| Automation | Yes |
| Automation Notes |  |
| Requirement References | Chỉ ngừng sử dụng khi không còn dữ liệu đang xử lý Không được xóa thiết bị đang được sử dụng. Thiết bị đang được sử dụng. |
| Covered Rules | Chỉ ngừng sử dụng khi không còn dữ liệu đang xử lý Không được xóa thiết bị đang được sử dụng. Thiết bị đang được sử dụng. |
| Source | Requirement Intelligence Engine |
...
## TC060 - Kết quả phải tuân thủ quyền xem dữ liệu của người dùng.
