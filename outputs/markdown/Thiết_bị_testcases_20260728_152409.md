...
Generated: 15:24:09 28 thg 7, 2026
...
| 4 | Kiểm tra kết quả nghiệp vụ | Hệ thống không tạo hoặc cập nhật bản ghi bằng giá trị Mã thiết bị đã tồn tại; dữ liệu hiện có không thay đổi. |

### Kết quả mong đợi

- Hệ thống không tạo hoặc cập nhật bản ghi bằng giá trị Mã thiết bị đã tồn tại; dữ liệu hiện có không thay đổi.
...
```text
Trường bắt buộc: Trường bắt buộc kiểm thử
```
...
```text
searchCriteria:
  searchCriteria: searchCriteria_1
```
